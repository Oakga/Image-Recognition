...
class BBox
{
  ...
  public:
    ...
    static boxList findLineBoxesHorizontal(int *PP, const int PPSize,boxNode* imgBox)
    {
        int minRow, maxRow = 0;
        boxList boxHead;
        int index = 0;
        ...
        static boxList findLineBoxesVertical(int *PP, const int PPSize,boxNode* imgBox)
    {
        int minCol, maxCol = 0;
        boxList boxHead;
        int index = 0;
...
int main(int argc, char *argv[])
{
    ...
    {
        BBox::boxList lineList = box.findLineBoxesHorizontal(textImage.HPPbin, textImage.numRows, box.imgBox);
        lineList.printList();  
        ...
        while(lineWalker != 0 ){
            ...
            lineWalker->printbox();
            boxNode* newbox= textImage.computePP(lineWalker);
            textImage.thresholdVertical();

            wordList = box.findLineBoxesVertical(textImage.VPPbin, textImage.numCols,);
            wordList.printList();
