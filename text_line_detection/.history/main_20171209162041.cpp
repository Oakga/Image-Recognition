...
class BBox
{
  ...
  public:
    ...
    boxList findLineBoxes(boxNode &imgBox, const int readingDir, int *PP, const int PPSize)
    {
        int minCol, maxCol = 0;
        int minRow, maxRow = 0;
        boxList boxHead;
        ...
        while (index < PPSize)
        {
            ...
            if( readingDir == 1) minRow = index;  //given PP is HPPbin and readingDir 1 is horizontal
            else minCol = index;
