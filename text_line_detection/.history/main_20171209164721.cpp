...
class BBox
{
  ...
  public:
    ...
    */
    ...
    static boxList findWordBoxes(boxNode &LineBox, const int dirOfPP, int *PP, const int PPSize)
    {
        int minCol, maxCol = 0;
        int minRow, maxRow = 0;
        boxList boxHead;
        ...
        while (index < PPSize)
        {
            ...
            if (index < PPSize)
            {
                ...
                if( dirOfPP == 1) { 
                    ...
                    maxCol = index;
                    //row is consistant
                    boxNode *newBox = new boxNode(3, lineBox.minRow, minCol, imgBox.maxRow, lineCol);
                    boxHead.insertLast(newBox);
                }
            };
        }
