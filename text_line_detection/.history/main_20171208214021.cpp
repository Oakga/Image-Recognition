...
int main(int argc, char *argv[])
{
    ...
    {
        BBox::boxList list = box.findLineBoxesVertical(textImage.HPPbin, textImage.numRows);
        list.printList();  
    ...
    {
        BBox::boxList list = box.findLineBoxesHorizontal(textImage.VPPbin, textImage.numCols);
        list.printList();
        textImage.clearArrays();
        boxNode* walker = list.listHead->nextBox;
        while(walker != 0 ){
