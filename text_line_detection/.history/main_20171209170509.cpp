...
int main(int argc, char *argv[])
{
    ...
    if (readingDir == 0)
    {
        BBox::boxList lineList = BBox::findLineBoxes(textImage, imgBox, 0, textImage.VPPbin, textImage.numCols);
    }
    else {
        BBox::boxList lineList = BBox::findLineBoxes(textImage, imgBox, 1, textImage.HPPbin, textImage.numRows);
    }
};    
