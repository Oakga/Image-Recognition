...
class BBox
{
  ...
  public:
    ...
    boxNode* findImgBox(imagePP &img, int **&imgAry, const int numRows, const int numCols)
    {
        bool firstTime = true;
        for (int i = 0; i < numRows; i++)
        {
...
int main(int argc, char *argv[])
{
    ...
    boxProcessor.findImgBox(textImage, textImage.imageAry, textImage.numRows, textImage.numCols); //image box
