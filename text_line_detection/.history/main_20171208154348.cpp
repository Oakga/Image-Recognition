...
class BBox
{
  ...
  public:
    ...
    static boxList findLineBoxes(int *PP, const int PPSize)
    {
        int minRow, maxRow = 0;
        boxList boxHead;
        int index = 0;
        while (index < PPSize)
        {
            ...
            boxNode *newBox = new boxNode(2, minRow, newBox->minCol, maxRow, newBox->minCol);
...
int main(int argc, char *argv[])
{
    ...
    box.findImgBox(processor.imageAry, processor.numRows, processor.numCols); //image box
