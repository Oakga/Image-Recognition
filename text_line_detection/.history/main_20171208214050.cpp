...
int main(int argc, char *argv[])
{
    ...
    {
        BBox::boxList list = box.findLineBoxesHorizontal(textImage.HPPbin, textImage.numRows);
        list.printList();  

        boxNode* walker = list.listHead->nextBox;
        while(walker != 0 ){
    ...
    {
        BBox::boxList list = box.findLineBoxesVertical(textImage.VPPbin, textImage.numCols);
        list.printList();
        textImage.clearArrays();
        boxNode* walker = list.listHead->nextBox;
        while(walker != 0 ){
