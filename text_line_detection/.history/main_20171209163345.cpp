...
int main(int argc, char *argv[])
{
    ...
    if (readingDir == 1)
    {
        BBox::boxList lineList = BBox::findLineBoxes(box, , textImage.VPPbin, textImage.numRows);
    }
    else {
        BBox::boxList lineList = BBox::findLineBoxes(box, 0, textImage.HPPbin, textImage.numRows);
    }
